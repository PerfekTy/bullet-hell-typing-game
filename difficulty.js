setInterval(function () {
    if (timerSec !== 0 && timerSec % 30 === 0 && level < 10) {
        levelUp();
        manageBulletWaves();
    }
}, 1000);
...
function wave6()
{
    generateBullet(1, 0, -3, 5, 4, 0, bullet1.size, bullet1.canSplit, 0, bullet1.explodeTime);
    generateBullet(1, 0, -3, -5, 4, 0, bullet1.size, bullet1.canSplit, 0, bullet1.explodeTime);
    generateBullet(2, 0, 0, 0, 0, 0, bullet2.size, bullet2.canSplit, 0, bullet2.explodeTime);
}
...
function wave7()
{
    generateBullet(2, 0, 0, 0, 0, 0, bullet2.size, bullet2.canSplit, 50, Date.now() + Math.random() * 2000);
}

function wave8()
{
    generateBullet(2, 0, 0, 10, 10, 0, bullet2.size, bullet2.canSplit, 0, Date.now() + Math.random() * 700);
    generateBullet(2, 0, 0, 0, 10, 0, bullet2.size, bullet2.canSplit, 0, Date.now() + Math.random() * 700);
    generateBullet(2, 0, 0, -10, 10, 0, bullet2.size, bullet2.canSplit, 0, Date.now() + Math.random() * 700);
}

function wave9()
{
    generateBullet(0, -1 + bossX, -3, 0, 10, 0, bullet0.size, bullet0.canSplit, 0, bullet0.explodeTime);
    generateBullet(0, 1 + bossX, -3, 0, 10, 0, bullet0.size, bullet0.canSplit, 0, bullet0.explodeTime);
    generateBullet(0, 0 + bossX, -3, 0, 10, 0, bullet0.size, bullet0.canSplit, 0, bullet0.explodeTime);
    generateBullet(0, 2 + bossX, -3, 0, 10, 0, bullet0.size, bullet0.canSplit, 0, bullet0.explodeTime);
    generateBullet(0, -2 + bossX, -3, 0, 10, 0, bullet0.size, bullet0.canSplit, 0, bullet0.explodeTime);
}
...
function wave10()
{
    ...
    {
        generateBullet(0, i, 0, 0, 20, 0, bullet0.size, bullet0.canSplit, 0, bullet0.explodeTime);
    }
}
